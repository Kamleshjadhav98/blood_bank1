...
$sql = "SELECT `id`, `name`, `gender`, `age`, `mo_number`, `email`, `blood_group`, `medicaly_fit`, `address`, `date` FROM `donarradd` WHERE  blood_group='A+' ";
...
<table border="2" ><h2><td style="font-size: 20px;"><a href="home1.html"> Back </a></td></h2></table>
				
    <h1 align="center"> A- Donner List </h1>
