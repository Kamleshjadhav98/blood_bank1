...
$sql = "SELECT `id`, `name`, `gender`, `age`, `mo_number`, `email`, `blood_group`, `medicaly_fit`, `address`, `date` FROM `donarradd` WHERE  gender='female' ";
...
<table border="2"><h3><td style="font-size: 20px;"><a href="report.html">  Back </a></td></h3></table>
    ...
    <h1 align="center"> Female Month Donner List </h1>
