...
$sql = "SELECT `id`, `name`, `gender`, `age`, `mo_number`, `email`, `blood_group`, `medicaly_fit`, `address`, `date` FROM `donarradd` WHERE  blood_group='O+' ";
...
.table{ text-shadow: 2px 2px 5px red; font-size:20px;}
	...
	h1{ test-shadow: 2px 2px 5px red;}
</style>
    <meta charset="UTF-8">
...
<table border="2"><h3><td style="font-size: 20px;"><a href="home1.html"> Back </a></td></h3></table>
    ...
    <h1 align="center"> O+ Donner List </h1>
