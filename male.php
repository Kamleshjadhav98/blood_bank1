...
$sql = "SELECT `id`, `name`, `gender`, `age`, `mo_number`, `email`, `blood_group`, `medicaly_fit`, `address`, `date` FROM `donarradd` WHERE  gender='male' ";
...
<table border="2"><h3><td style="font-size: 20px;"><a href="report.html">  Back </a></td></h3></table>
				
    <h1 align="center"> Male Donner List </h1>
   <table border="3px" style="width:100%; line-height:40px; color:black;font-style:italic;">
        <thead bgcolor="red">
            <tr style="font-variant:small-caps; color:black; font-size:18px; text-shadow: 2px 2px 5px red; bgcolor=red;">
	<th class="table"  bgcolor="grey">Id</th>
                <th class="table" bgcolor="grey">Name</th>
	<th  class="table" bgcolor="red">Gender</th>
	<th  class="table" bgcolor="grey">Age</th>
	<th  class="table" bgcolor="grey">Mobile No</th>
                <th  class="table" bgcolor="grey">Email</th>
	<th  class="table" bgcolor="grey">Blood Group</th>
