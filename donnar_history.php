...
<table class="table" border="2"><h3><td style="font-size: 22px; font-style:italic;"><a href="home1.html"> Back </a></td></h3></table>
    ...
    <h1 align="center">Display All Donner List </h1>
	...
	{
	  echo("<tr><td>".$row["id"]."</td><td padding: 5>".$row["name"]."</td><td>".$row["gender"]."</td><td>".$row["age"]."</td><td>".$row["mo_number"]."</td><td>".$row["email"]."</td><td>".$row["blood_group"]."</td><td>".$row["medicaly_fit"]."</td><td>".$row["address"]."</td><td>".$row["date"]."</td></tr>");
	}
          ?>
        </tbody>
      </table>
